...
<div id="review-container">
    ...
    <section class="review">
        <h2 class="location">Kyoto, Japan</h2>
        <p class="author">Bob</p>
        <p class="date">2023-07-20</p>
        <p class="comments">Kyoto's temples are serene and beautiful. I could spend days wandering around the bamboo forests..</p>
    </section>
    ...
    <section class="review">
        <h2 class="location">Cusco, Peru</h2>
        <p class="author">Diana</p>
        <p class="date">2023-11-05</p>
        <p class="comments">Cusco is rich in history and culture. Machu Picchu is a once-in-a-lifetime experience.</p>
    </section>
